    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for(int i=0;i<articles.length();i++) {
                ...
                JSONObject providerObj = article.getJSONObject("source");
                String provider = providerObj.getString("name");
                String content = article.getString("content");
                String date = article.getString("publishedAt");

                news.add(new News(title, provider, author, desc, url, imageUrl, date, content));
            }
